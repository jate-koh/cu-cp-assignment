...
# Modified to accept arguments to input from single command line
# By Jatetanan
parser = argparse.ArgumentParser(description='Brute-force password')
parser.add_argument('password', type=str, help='Password to find')
parser.add_argument('--max_nchar', type=int, default=8,
                    help='Maximum number of characters of password')
...
def bruteforce(password, max_nchar=args.max_nchar):
    """Password brute-force algorithm.
    Parameters
    ----------
    password : string
